...
def difference_with_taylorf2(h, params, quad1=None, quad2=None, spin_spin=True):
    """Compare with TaylorF2 waveform.
    """
    q, spin1z, spin2z, lambda1, lambda2 = params
    mf = h.x
...
def condition_eob_waveform(
    ...
    hf2, dh = difference_with_taylorf2(htilde, params, quad1=quad1, quad2=quad2, spin_spin=spin_spin)
