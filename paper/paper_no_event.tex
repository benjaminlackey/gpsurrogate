...
%With this surrogate we do a Bayesian analysis of GW170817 and measure the combined tidal parameter $\tilde\Lambda$ to be \red{$x_{-y}^{+z}$} (median and 90\% highest posterior density interval).
