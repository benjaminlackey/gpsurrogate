...
%Unfortunately, direct comparisons of the PDF between this code and traditional samplers using the same waveform models have not been published for BNS systems. It is therefore not clear how accurate this code is for measuring quantities such as the tidal parameters. 
The measured tidal parameter using EOB waveforms and \texttt{RapidPE} were broadly consistent with the results using frequency-domain waveforms and traditional samplers (Fig. 9 of Ref.~\cite{O2Catalog}). However, a direct comparison using identical waveforms has not yet been published for BNS systems.
