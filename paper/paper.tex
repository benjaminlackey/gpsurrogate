...
%We note that, to date, this is the only tidal EOB model that includes the effect of spin \red{[[Sebastiano also has a model that includes spin and tides.]]}\blue{[[Which is the Reference?]]}. 
