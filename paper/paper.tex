...
\label{eq:hdecomp}
\end{align}
The exact functional form of the TaylorF2 waveform is given in Appendix~\ref{sec:taylorf2}, and the residuals are shown in Fig.~\ref{fig:hoff}. 
